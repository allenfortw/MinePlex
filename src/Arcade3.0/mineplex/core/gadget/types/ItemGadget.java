...
public abstract class ItemGadget extends Gadget
{
	...
	public void ApplyItem(Player player, boolean inform)
	{
		...
		itemLore.add(C.cWhite + "Your Ammo : " + 10000);
		
		player.getInventory().setItem(Manager.getActiveItemSlot(), ItemStackFactory.Instance.CreateStack(GetDisplayMaterial(), GetDisplayData(), 1, F.item("" + 10000) + " " + GetName()));
