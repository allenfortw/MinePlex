...
{
    public GadgetPage(CosmeticManager plugin, CosmeticShop shop, CoreClientManager clientManager, String name, Player player)
    {
    ...
    protected void addGadget(Gadget gadget, int slot)
    {
    	...
    	if (gadget instanceof ItemGadget)
    	{
    		...
    		itemLore.add(C.cBlack);
    		itemLore.add(C.cWhite + "Your Ammo : " + C.cGreen + 10000);
    	}
