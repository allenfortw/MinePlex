...
public class PetManager extends MiniClientPlugin<PetClient>
{
	...
	public PetManager(JavaPlugin plugin, CoreClientManager clientManager, DisguiseManager disguiseManager, mineplex.core.creature.Creature creatureModule, BlockRestore restore, String webAddress)
	{
