...
public class ClassManager extends MiniClientPlugin<ClientClass> implements IClassFactory
{
	...
	public ClassManager(JavaPlugin plugin, CoreClientManager clientManager,
	...
	private void LoadClassBuilds(ClientClassTokenWrapper token)
	{
		...
		{
			Set(token.Name,
					new ClientClass(this, _skillFactory, _itemFactory, _clientManager.Get(token.Name), token.DonorToken));
		}
	}
	...
	{
		return new ClientClass(this, _skillFactory, _itemFactory, _clientManager.Get(player), null);
	}
