...
{
	public ArmorPage(ClassShopManager shopManager, ClassCombatShop shop, CoreClientManager clientManager, Player player)
	{        
		super(shopManager, shop, clientManager, "       Armor", player);
	...
	{			
		...
		getShop().openPageForPlayer(getPlayer(), new CustomBuildPage(getPlugin(), getShop(), getClientManager(), player));
	}
