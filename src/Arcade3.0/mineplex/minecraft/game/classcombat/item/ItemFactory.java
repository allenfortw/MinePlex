...
import mineplex.minecraft.game.classcombat.item.weapon.BoosterAxe;
import mineplex.minecraft.game.classcombat.item.weapon.BoosterSword;
import mineplex.minecraft.game.classcombat.item.weapon.PowerAxe;
import mineplex.minecraft.game.classcombat.item.weapon.PowerSword;
import mineplex.minecraft.game.classcombat.item.weapon.StandardAxe;
import mineplex.minecraft.game.classcombat.item.weapon.StandardBow;
import mineplex.minecraft.game.classcombat.item.weapon.StandardSword;
