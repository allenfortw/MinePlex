...
public class SpectatorShop extends ShopBase<CompassAddon>
{
	...
	public SpectatorShop(CompassAddon plugin, ArcadeManager arcadeManager, CoreClientManager clientManager, CurrencyType... currencyTypes)
	{
		super(plugin, clientManager, "Spectate Menu", currencyTypes);
	...
	{
		return new SpectatorPage(getPlugin(), _arcadeManager, this, getClientManager(), player);
	}
