...
public class SpectatorPage extends ShopPageBase<CompassAddon, SpectatorShop>
{
	...
	public SpectatorPage(CompassAddon plugin, ArcadeManager arcadeManager, SpectatorShop shop, CoreClientManager clientManager, Player player)
	{
		super(plugin, shop, clientManager, "Spectator Menu", player);
