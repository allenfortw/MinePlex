...
public class TimePage extends ShopPageBase<ArcadeManager, OptionsShop>
{
	...
	public TimePage(Build game, ArcadeManager plugin, OptionsShop shop, CoreClientManager clientManager, Player player)
	{
		super(plugin, shop, clientManager, "Set Time", player, 18);
		_game = game;
		buildPage();
	}
