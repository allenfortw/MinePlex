...
public class ParticlesPage extends ShopPageBase<ArcadeManager, OptionsShop>
{
	...
	public ParticlesPage(Build game, ArcadeManager plugin, OptionsShop shop, CoreClientManager clientManager, Player player)
	{
		super(plugin, shop, clientManager, "Add Particles", player);
		_game = game;
		buildPage();
	}
