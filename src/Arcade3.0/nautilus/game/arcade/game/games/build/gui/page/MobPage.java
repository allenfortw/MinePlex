...
public class MobPage extends ShopPageBase<ArcadeManager, MobShop>
{
	...
	public MobPage(ArcadeManager plugin, MobShop shop, CoreClientManager clientManager, Player player, BuildData buildData, Entity entity)
	{
		super(plugin, shop, clientManager, "Mob Options", player, 9);
