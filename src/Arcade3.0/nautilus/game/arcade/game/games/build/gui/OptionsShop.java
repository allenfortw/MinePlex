...
public class OptionsShop extends ShopBase<ArcadeManager>
{
	...
	public OptionsShop(Build game, ArcadeManager plugin, CoreClientManager clientManager)
	{
		super(plugin, clientManager, "Options");
		_game = game;
	}
	...
	{
		return new OptionsPage(_game, getPlugin(), this, getClientManager(), player);
	}
}
