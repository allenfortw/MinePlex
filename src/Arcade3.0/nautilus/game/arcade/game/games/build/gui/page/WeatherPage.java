...
public class WeatherPage extends ShopPageBase<ArcadeManager, OptionsShop>
{
	...
	public WeatherPage(Build game, ArcadeManager plugin, OptionsShop shop, CoreClientManager clientManager, Player player)
	{
		super(plugin, shop, clientManager, "Set Weather", player, 18);
		_game = game;
		buildPage();
	}
