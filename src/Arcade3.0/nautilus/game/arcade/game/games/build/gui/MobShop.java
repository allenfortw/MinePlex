...
{
	public MobShop(ArcadeManager plugin, CoreClientManager clientManager)
	{
		super(plugin, clientManager, "Mob Options");
	}
	...
	{
		return new MobPage(getPlugin(), this, getClientManager(), player, data, entity);
	}
