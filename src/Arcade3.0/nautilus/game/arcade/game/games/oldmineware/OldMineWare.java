...
import nautilus.game.arcade.game.games.oldmineware.random.ActionMilkCow;
import nautilus.game.arcade.game.games.oldmineware.random.ActionShearSheep;
import nautilus.game.arcade.game.games.oldmineware.random.CraftLadder;
import nautilus.game.arcade.game.games.oldmineware.random.CraftStoneShovel;
import nautilus.game.arcade.game.games.oldmineware.random.DamageChicken;
import nautilus.game.arcade.game.games.oldmineware.random.DamageFall;
import nautilus.game.arcade.game.games.oldmineware.random.DamageGhast;
import nautilus.game.arcade.game.games.oldmineware.random.GatherCobble;
import nautilus.game.arcade.game.games.oldmineware.random.GatherRedFlower;
import nautilus.game.arcade.game.games.oldmineware.random.GatherSand;
import nautilus.game.arcade.game.games.oldmineware.random.GatherYellowFlower;
import nautilus.game.arcade.game.games.oldmineware.random.PlaceDoor;
import nautilus.game.arcade.game.games.oldmineware.random.RideBoat;
import nautilus.game.arcade.game.games.oldmineware.random.RidePig;
import nautilus.game.arcade.game.games.oldmineware.random.StandAlone;
import nautilus.game.arcade.game.games.oldmineware.random.StandShelter;
import nautilus.game.arcade.game.games.oldmineware.random.StandStone;
import nautilus.game.arcade.game.games.oldmineware.random.StandWater;
