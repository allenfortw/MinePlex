...
public class SpellMenuPage extends ShopPageBase<WizardSpellMenu, WizardSpellMenuShop>
{
	...
	public SpellMenuPage(WizardSpellMenu plugin, WizardSpellMenuShop shop, CoreClientManager clientManager, Player player, Wizards wizard)
	{
		super(plugin, shop, clientManager, "Spell Menu", player);
		_wizard = wizard;
		buildPage();
	}
