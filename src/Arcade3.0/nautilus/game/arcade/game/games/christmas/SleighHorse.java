    ...
    public void onTick()
    {
        ...
        if (entityTrackerEntry != null)
        {
            ...
            if (!newLocation.equals(_lastFacing))
            {
				...
				HashSet<EntityPlayer> trackedPlayers = (HashSet<EntityPlayer>) entityTrackerEntry.trackedPlayers;
                @SuppressWarnings("unchecked")
				HashSet<EntityPlayer> cloned = (HashSet<EntityPlayer>) trackedPlayers.clone();
