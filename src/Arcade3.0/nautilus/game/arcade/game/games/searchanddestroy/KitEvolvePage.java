...
public class KitEvolvePage extends ShopPageBase<KitEvolve, KitEvolveShop>
{
    ...
    public KitEvolvePage(KitEvolve plugin, SearchAndDestroy arcadeManager, KitEvolveShop shop, CoreClientManager clientManager, Player player, ArrayList<UpgradeKit> kits)
    {
        super(plugin, shop, clientManager, "Kit Evolution", player);
