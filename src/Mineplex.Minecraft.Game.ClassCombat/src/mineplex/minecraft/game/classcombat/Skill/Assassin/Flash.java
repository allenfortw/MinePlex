...
public class Flash extends SkillActive
{
	...
	public void Recharge(UpdateEvent event)
	{
		for (Player cur : GetUsers())
			...
			else
			{
				...
				if (!mineplex.core.recharge.Recharge.Instance.use(cur, "Flash Recharge", 8000, false))
					continue;
	...
	{
		//Use Recharge
		mineplex.core.recharge.Recharge.Instance.use(player, "Flash Recharge", 8000, false);
