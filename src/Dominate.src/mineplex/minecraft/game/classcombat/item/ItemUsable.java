  ...
  implements IThrown
{
  ...
  private boolean EnergyRecharge(Player player, String ability, int energy, long recharge)
  {
    ...
    if (!Recharge.Instance.use(player, ability, recharge, recharge > 2000L)) {
      return false;
    }
