  ...
  implements IThrown
{
  ...
  public void Skill(Player player, int level)
  {
    ...
    UtilAction.velocity(item, player.getLocation().getDirection(), 1.2D, false, 0.0D, 0.1D, 10.0D, false);
    this.Factory.Projectile().AddThrow(item, player, this, -1L, true, true, true, 1.0D);
