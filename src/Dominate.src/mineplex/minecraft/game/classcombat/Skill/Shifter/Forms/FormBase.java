  ...
  extends Skill
{
  ...
  {
    throw new Error("Unresolved compilation problems: \n\tThe method ClassManager() is undefined for the type SkillFactory\n\tThe method AddSkill(ISkill) in the type ClientClass is not applicable for the arguments (ISkill, int)\n");
  }
  ...
  {
    throw new Error("Unresolved compilation problems: \n\tThe method ClassManager() is undefined for the type SkillFactory\n\tThe method AddSkill(ISkill) in the type ClientClass is not applicable for the arguments (ISkill, Integer)\n");
  }
