...
public class ShockingStrikes extends Skill
{
  public ShockingStrikes(SkillFactory skills, String name, IPvpClass.ClassType classType, ISkill.SkillType skillType, int cost, int levels)
  {
    ...
    SetDesc(
      ...
      "1 second, giving them Slow I and", 
      "Screen-Shake." });
  }
  ...
  public void Damage(CustomDamageEvent event)
  {
    ...
    this.Factory.Condition().Factory().Shock(GetName(), damagee, damager, 1.0D, true, true);
    this.Factory.Condition().Factory().Slow(GetName(), damagee, damager, 1.0D, 0, true, true, false, true);
