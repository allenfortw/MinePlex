...
public class BullsCharge extends SkillActive
{
	...
	{
		//Action
		Factory.Condition().Factory().Speed(GetName(), player, player, 8, 1, false, true, true);
	...
	public void Damage(CustomDamageEvent event)
	{
		...
		//Condition
		Factory.Condition().Factory().Slow(GetName(), damagee, damager, 4, 3, false, true, true, true);
