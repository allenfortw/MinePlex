  ...
  extends Skill
{
  ...
  public void Damage(CustomDamageEvent event)
  {
    ...
    if (this._hitCount.containsKey(player))
    {
      ...
      event.AddMod(player.getName(), GetName(), ((Integer)this._hitCount.get(player)).intValue() * 2, true);
      
      int limit = Math.min(3, ((Integer)this._hitCount.get(player)).intValue() + 1);
