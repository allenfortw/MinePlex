...
public class Immolate extends Skill
{
  ...
  public void Remove(Player player)
  {
    ...
    this.Factory.Condition().Factory().FireResist(GetName(), player, player, 0.9D, 0, false, true, true);
  }
  ...
  public void Conditions() {
    for (Player cur : GetUsers())
    {
      if (this._active.contains(cur))
      {
        ...
        this.Factory.Condition().Factory().Strength(GetName(), cur, cur, 1.9D, 3, false, true, true);
        this.Factory.Condition().Factory().FireResist(GetName(), cur, cur, 1.9D, 0, false, true, true);
        this.Factory.Condition().Factory().Vulnerable(GetName(), cur, cur, 1.9D, 1, false, true, true);
      }
    }
  }
  ...
  public void Flames() {
    for (Player cur : GetUsers())
    {
      if (this._active.contains(cur))
      {
        ...
        this.Factory.Fire().Add(fire, cur, 1.0D, 0.0D, 1.2D, 0, GetName());
