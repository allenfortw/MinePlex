  ...
  extends Skill
{
  ...
  public void RegisterDamage(CustomDamageEvent event)
  {
    ...
    if (!((HashMap)this._vengeance.get(damagee)).containsKey(damager.getName())) {
      ...
      ((HashMap)this._vengeance.get(damagee)).put(damager.getName(), Integer.valueOf(Math.min(level * 2, ((Integer)((HashMap)this._vengeance.get(damagee)).get(damager.getName())).intValue() + 1)));
    }
  }
  ...
  public void IncreaseDamage(CustomDamageEvent event)
  {
    ...
    event.AddMod(damager.getName(), GetName(), ((Integer)((HashMap)this._vengeance.get(damager)).remove(damagee.getName())).intValue(), true);
  }
